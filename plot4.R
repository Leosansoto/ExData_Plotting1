...
par(mfcol = c(2,2))
#
plot(consume_period$dt, consume_period$Global_active_power, type = "l", xlab = "", ylab ="Global Active Power(kilowatts)")
#
...
#
plot(consume_period$dt, consume_period$Voltage, type = "l", col = "black", xlab = "datetime", ylab ="Voltage")
#
plot(consume_period$dt, consume_period$Global_reactive_power, type = "l", col = "black", xlab = "datetime", ylab ="Global Reactive Power")
#
